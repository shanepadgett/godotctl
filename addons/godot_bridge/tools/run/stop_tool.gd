...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_stop"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_stop is unavailable")
	return service.call("execute_stop", args)
