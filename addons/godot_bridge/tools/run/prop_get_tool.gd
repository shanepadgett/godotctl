...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_prop_get"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_prop_get is unavailable")
	return service.call("execute_prop_get", args)
