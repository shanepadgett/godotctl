...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_status"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_status is unavailable")
	return service.call("execute_status", args)
