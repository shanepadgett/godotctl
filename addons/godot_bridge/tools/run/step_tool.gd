...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_step"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_step is unavailable")
	return service.call("execute_step", args)
