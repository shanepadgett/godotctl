...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_logs"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_logs is unavailable")
	return service.call("execute_logs", args)
