...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_input_event"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_input_event is unavailable")
	return service.call("execute_input_event", args)
