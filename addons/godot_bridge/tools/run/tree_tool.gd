...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_tree"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_tree is unavailable")
	return service.call("execute_tree", args)
