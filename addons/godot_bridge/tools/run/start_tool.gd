...
func execute(args: Dictionary) -> Dictionary:
	...
	if not service.has_method("execute_start"):
		return _result.error(_errors.INTERNAL, "runtime bridge service execute_start is unavailable")
	return service.call("execute_start", args)
